...
class Settings:
    ...
    PROVIDERS: Dict[str, ProviderConfig] = {
        "netlab": {
            ...
            "optional": ["TOKEN", "TOKEN_EXPIRES_IN"],
        },
        "treolan": {
            "prefix": "TREOLAN_",
            "required": ["LOGIN", "PASSWORD", "AUTH_URL", "API_URL"],
    ...
    def netlab_config(self) -> Dict[str, str]:
        return {
            ...
            "token": self.NETLAB_TOKEN,
            "token_expires_in": self.NETLAB_TOKEN_EXPIRES_IN,
        }
    ...
    def treolan_config(self) -> Dict[str, str]:
        return {
            ...
            "token": self.TREOLAN_TOKEN,
            "token_expires_in": self.TREOLAN_TOKEN_EXPIRES_IN,
        }
    ...
    def ocs_config(self) -> Dict[str, str]:
        return {
            "login": self.OCS_LOGIN,
            "password": self.OCS_PASSWORD,
        }
